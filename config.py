...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "24104568")  # ⚠️ Required
    API_HASH  = os.environ.get("API_HASH", "96d4cada419846dc011b019f412c23de") # ⚠️ Required
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6521891078:AAHxgMgG088f8frcVCaM-55ZAAkiDmhWHS8") # ⚠️ Required
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "Tdgjjbbdfg_bot") # ⚠️ Required
   
    # database config
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://Zenitsuaf:Zenitsuaf@cluster0.i58aapw.mongodb.net/?retryWrites=true&w=majority")  # ⚠️ Required
 
    # other configs
    DOWNLOAD_LOCATION = "./DOWNLOADS"
    TG_MAX_SIZE = 2040108421
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://envs.sh/i4C.jpg")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '5817124748').split()] # ⚠️ Required
    ...
    FORCE_SUB = os.environ.get('FORCE_SUB', '-1001670428579') # ⚠️ Required
    AUTH_CHANNEL = int(FORCE_SUB) if FORCE_SUB and id_pattern.search(
    FORCE_SUB) else None
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001586987735")) # ⚠️ Required
